...
exports.AppleHealthParser = void 0;
...
class AppleHealthParser {
    ...
    async parseHealthExport(xmlPath) {
        const xmlContent = await promises_1.default.readFile(xmlPath, 'utf-8');
        const result = await (0, xml2js_1.parseStringPromise)(xmlContent, {
            explicitArray: false,
            mergeAttrs: true,
            normalizeTags: true,
            attrValueProcessors: [(value) => {
    ...
    async parseGPXRoute(gpxPath) {
        try {
            const gpxContent = await promises_1.default.readFile(gpxPath, 'utf-8');
            const result = await (0, xml2js_1.parseStringPromise)(gpxContent, {
                explicitArray: false,
                mergeAttrs: true,
                normalizeTags: true
            });
    ...
    calculateSplits(coordinates, splitDistance = 1000) {
        const splits = [];
        let currentSplit = {
            distance: 0,
            duration: 0,
        ...
        for (let i = 1; i < coordinates.length; i++) {
            ...
            const distance = this.calculateDistance(lastPoint.latitude, lastPoint.longitude, point.latitude, point.longitude);
...
exports.AppleHealthParser = AppleHealthParser;
exports.default = AppleHealthParser.getInstance();
//# sourceMappingURL=appleHealthParser.service.js.map